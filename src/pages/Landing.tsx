...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-primary/95 backdrop-blur-md border-b border-primary-dark text-primary-foreground">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-0">
            <img src={freshbitLogo} alt="Freshbit" className="h-12 w-auto" />
            <span className="font-bold text-lg text-primary-foreground -ml-5 -mt-1">freshbit</span>
          </Link>
